...
class LegalLogic:
    @staticmethod
    def generar_cufe(num_fac, fecha, hora, valor_fac, nit_emisor, doc_adqui, clave_tecnica, ambiente="1"):
        """
    ...
    def generar_qr_dian(tipo, num_doc, cufe, total):
        ...
        if not os.path.exists(folder_qr): os.makedirs(folder_qr)
        ...
        if cufe:
            ...
            contenido = f"Documento: {tipo} No: {num_doc}\nTotal: {total}\nFerreEnvios del Meta"
